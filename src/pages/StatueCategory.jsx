...
const StatueCategory = ({ itemsPerPage }) => {
  const [snailPics, setSnailPics] = useState([]);
  useEffect(() => {
    fetch("https://snail-pic-api.onrender.com/api/snail-pics/3D")
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
        // Captures all the snail pics of the current category
  ...
  // Invokes when user clicks to request another page.
